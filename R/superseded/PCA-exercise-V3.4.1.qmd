...
standardized_data <- scale(train_data, center = TRUE, scale = TRUE)

# Verify class type
class(standardized_data)

# Transform matrix to data frame
standard_df <- as.data.frame(standardized_data)
...
# data_description <- describe(train_data)
# as.data.frame(data_description)
# 
# # TRANSFORMATION - 1
# # Apply root transformation
# data_root <- train_data^(1/3)
# boxplot(data_root)
# 
# # Description after Root transformation
# root_description <- describe(data_root)
# as.data.frame(root_description)
# 
# # SPECIFIC FEATURE TRANSFORMATIONS
# # ------------------------------------
# # 01-pediatric_nPCR
# plot(data_root$pediatric_nPCR)
# describe(data_root$pediatric_nPCR)
# # use constant to eliminate skewness from max value
# data_root$pediatric_nPCR_skew <- data_root$pediatric_nPCR - 4 
# # root transformation to eliminate kurtosis
# data_root$pediatric_nPCR_root <- data_root$pediatric_nPCR_skew^(1/2)
# # add variable to data frame
# root_description <- describe(data_root)
# as.data.frame(root_description)
# # plot the new transformed variable
# plot(data_root$pediatric_nPCR_root)
# 
# # ------------------------------------
# # 02-pediatric_Kt_v_1.8
# plot(data_root$pediatric_Kt_v_1.8)
# describe(data_root$pediatric_Kt_v_1.8)
# # use constant to eliminate skewness from max value
# data_root$pediatric_Kt_v_1.8_skew <- data_root$pediatric_Kt_v_1.8 - 4 
# # root transformation to eliminate kurtosis
# data_root$pediatric_Kt_v_1.8_root <- data_root$pediatric_Kt_v_1.8_skew^(1/2)
# # add variable to data frame
# root_description <- describe(data_root)
# as.data.frame(root_description)
# # plot the new transformed variable
# plot(data_root$pediatric_Kt_v_1.8_root)

# ------------------------------------
# # 03-pediatric_Kt_v_1.2
# plot(data_root$pedriatic_Kt_v_1.2)
# describe(data_root$pedriatic_Kt_v_1.2)
# # root transformation to eliminate kurtosis
# data_root$pedriatic_Kt_v_1.2_root <- 1 / data_root$pedriatic_Kt_v_1.2^(1/2)
# # add variable to data frame
# root_description <- describe(data_root)
# as.data.frame(root_description)
# # plot the new transformed variable
# plot(data_root$pedriatic_Kt_v_1.2_root)
# 
# # ------------------------------------
# # 04-Kt_v_1.2
# plot(data_root$Kt_v_1.2)
# describe(data_root$Kt_v_1.2)
# # use constant to eliminate skewness from max value
# data_root$Kt_v_1.2_skew <- data_root$Kt_v_1.2  - 9 
# # root transformation to eliminate kurtosis
# data_root$Kt_v_1.2_root <- data_root$Kt_v_1.2_skew^(2) 
# # add variable to data frame
# root_description <- describe(data_root)
# as.data.frame(root_description)
# # plot the new transformed variable
# plot(data_root$Kt_v_1.2_root)
```

```{r}
#adjust plot margins
# par(mar = c(1, 1, 1, 1))
# # Plot a scatter plot matrix for all variables
# pairs(standard_df$expected_survival ~ standard_df$Kt_v_1.2 + standard_df$`hypercalcemia_calcium > 10.2Mg`, standard_df)
# 
# boxcox_data <- boxcox(expected_survival ~ ., data = train_data,
#        lambda = seq(-3, 3, length.out = 10))
```
...
corr_matrix <- cor(scaled_trans_data)
