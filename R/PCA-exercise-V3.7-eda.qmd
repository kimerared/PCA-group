...
for (col in colnames(train_data)) {
  median_value <- mean(train_data[[col]], na.rm = TRUE)
...
target_index <- get_target_index(training_set, target_name)
...
pca <- preProcess(training_set[, -training_target_index],
...
# fit PCR
pcr_model <- pcr(y ~ PC1+PC6, data=train_pca, validation="CV")
