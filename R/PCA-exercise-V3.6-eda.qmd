...
train_data_subset$`hypercalcemia_calcium > 10.2Mg` <- 1/(train_data_subset$`hypercalcemia_calcium > 10.2Mg`)
boxplot(train_data_subset$`hypercalcemia_calcium > 10.2Mg`)
plot_qq(train_data_subset$`hypercalcemia_calcium > 10.2Mg`)

boxplot(train_data_subset$`phosphorus < 3.5Mg`)
plot_qq(train_data_subset$`phosphorus < 3.5Mg`)
phosphorus_3.5 <- 1/(train_data_subset$`phosphorus < 3.5Mg`)^(1/4)
boxplot(phosphorus_3.5)
```
