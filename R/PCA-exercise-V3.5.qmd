...
-   Standardization is useful when the data is normally distributed and there are outliers
...
```{r}
qqnorm(standard_df$expected_survival,
       ylab="Sample Quantiles for Turbidity")

qqline(standard_df$expected_survival, col="magenta")

plotNormalHistogram(standard_df$expected_survival)
```
...
standard_df$expected_survival_N_scores <- blom(standard_df$expected_survival)

plotNormalHistogram(standard_df$expected_survival_N_scores)

# QQ plot
qqnorm(standard_df$expected_survival_N_scores,
       ylab="Sample Quantiles (QQ) for Expected Survival")
qqline(standard_df$expected_survival_N_scores, col="magenta")

boxplot(standard_df$expected_survival_N_scores)
